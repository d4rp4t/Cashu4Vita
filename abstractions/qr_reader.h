...
typedef enum {
    QR_READER_SCANNING,   // accumulating bc-ur parts (or waiting for first QR)
    QR_READER_COMPLETE,   // all parts received, result ready
    QR_READER_ERROR,      // bc-ur decode error
} qr_reader_state_t;
